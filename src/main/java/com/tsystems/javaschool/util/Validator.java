...
public class Validator {
     ...
     * @param data data for validating
     * @return error message or null, if data is valid
     */
    public static String noSpaces(String data) {
        if (null == data || data.isEmpty())
            return "Data is empty";
        if (data.contains(" "))
            return "Data contains whitespaces";
