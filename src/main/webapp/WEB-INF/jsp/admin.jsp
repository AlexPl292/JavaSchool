                    ...
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a id="new_customer" onclick="loadpage('new_customer')">Add new customer</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a id="new_tariff" onclick="loadpage('new_tariff')">Add new tariff</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a id="new_option" onclick="loadpage('new_option')">Add new option</a>
                                </li>
                                <li>
...
<script>
    ...
    function loadpage(page) {
        var element = $('#side-menu').find('#'+page);
